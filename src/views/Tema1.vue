    ...
    .bloque-texto-a.color-secundario.p-4.p-md-4.mb-5(data-aos="fade-right") 
      .row.m-0.align-items-center.justify-content-between
        .col-lg-4.mb-4.mb-lg-0
          figure
            img(src='@/assets/curso/tema1/img1.png', style="width:300px").m-auto
        .col-lg-8
          .bloque-texto-a__texto.p-4
            p.mb-0 #[b Una herramienta tecnológica para presentaciones digitales, es muy común y sencilla de utilizar, ya sea para presentar un producto o servicio, una idea o simplemente una información de interés, algunas disponibles se visualizan en la figura 1].
    .row.bg-color1
      .col-12.p-5
        .titulo-sexto.color-acento-contenido.mb-4
          p.mb-0 #[b Figura 1]. Herramientas tecnológicas
        .row.mb-4
    ...
    .row.justify-content-center.mb-5
      .col-lg-10
        .titulo-sexto.color-acento-contenido.mb-5
          p.mb-0 #[b Figura 5]. Estructura narrativa
        figure
    ...
    .row.mb-5
      .col-12.bg-color4.p-4
        .row.align-items-start(data-aos="fade-right")
          ...
          .col
            p.mb-0 En la figura se puede observar un esquema de una estructura narrativa lineal, donde se involucran los conceptos previamente nombrados. De esta misma forma se puede crear un texto o guion literario enfocado a una multimedia.
    .row.align-items-center.mb-5
      .col-lg-auto
        figure
      ...
      .col-lg.mb-4.mb-lg-0(data-aos="fade-right")
        ...
        ul.lista-ul--color.lista-ul--separador
          li 
            ...
            |
            p.mb-0 #[b Cuento]: narración corta con pocos personajes y desenlace rápido.
          li 
            i.fas.fa-pen-square(style="color:#FB8C00")
            |
            p.mb-0 #[b Leyenda]: narraciones que combinan situaciones reales y sobrenaturales.
          li 
            i.fas.fa-pen-square(style="color:#FB8C00")
            |
            p.mb-0 #[b Mito]: historia de corte fantástico que explica el origen de un lugar o acontecimiento.
          li 
            i.fas.fa-pen-square(style="color:#FB8C00")
            |
            p.mb-0 #[b Novela]: narración real o ficticia, más larga y compleja que un cuento.
          li 
            i.fas.fa-pen-square(style="color:#FB8C00")
            |
            p.mb-0 #[b Crónica]: texto que sigue un orden temporal de los hechos para contar una historia.
          li 
            i.fas.fa-pen-square(style="color:#FB8C00")
            |
            p.mb-0 #[b Noticia]: género periodístico que narra brevemente un suceso actual.
          li 
            i.fas.fa-pen-square(style="color:#FB8C00")
            |
            p.mb-0 #[b Reportaje]: investigación periodística extensa sobre una persona o hecho.
          li 
            i.fas.fa-pen-square(style="color:#FB8C00")
            |
            p.mb-0 #[b Biografía]: narración sobre la vida de una persona.
          li 
            i.fas.fa-pen-square(style="color:#FB8C00")
            |
